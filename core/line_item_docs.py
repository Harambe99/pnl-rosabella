...
LINE_ITEM_DOCS = {
    ...
    'FBT Hub Placement Fee': {
        ...
        'notes': 'RETIRED 2026-09-08 - no longer booked to the P&L. TikTok confirmed (Jocelyn Zeng, 2026-09-01) that the Settlement "FBT warehouse service fee using GMV payment" line already bundles this fee, so booking it here double-counted it. FBT Warehouse Service Fee is now the single source of truth, itemised beneath it by the FBT Bill breakdown rows. The MonthlyInput field is still populated by the Logistics Cost Overview upload and still appears on Source - FBT Billing for cross-checking.',
    },
    'FBT Storage Fee': {
